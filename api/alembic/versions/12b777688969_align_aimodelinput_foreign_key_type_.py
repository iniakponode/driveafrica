"""Align AIModelInput foreign key type with Trip

Revision ID: 12b777688969
Revises: fa06ae235ce9
Create Date: 2024-10-26 00:25:04.442480
...
revision: str = '12b777688969'
down_revision: Union[str, None] = 'fa06ae235ce9'
...
def upgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['trip_id'], ['trip_data.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.ForeignKeyConstraint(['location_id'], ['location.id'], ),
    sa.ForeignKeyConstraint(['tripId'], ['trip_data.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
