...
fun VehicleMonitoringGate() {
    ...
    val requestPermissionsLauncher = rememberLauncherForActivityResult(
        ...
        if (granted) {
            startMonitoringIfReady(context)
        }
    }
    ...
    LaunchedEffect(permissionsGranted.value, driverProfileId.value, autoMonitoringEnabled) {
        if (permissionsGranted.value && autoMonitoringEnabled) {
            startMonitoringIfReady(context)
...
private fun startMonitoringIfReady(context: Context) {
