...
5. **Behaviour analysis** – `NewUnsafeDrivingBehaviourAnalyser` processes accelerometer, rotation, and speed windows to emit harsh acceleration/braking, harsh cornering, swerving, aggressive turns, aggressive stop-and-go, phone handling, fatigue, rough-road speeding, crash detection, and speeding events using adaptive thresholds and location-aware speed limits.【F:core/src/main/java/com/uoa/core/behaviouranalysis/NewUnsafeDrivingBehaviourAnalyser.kt†L40-L178】
