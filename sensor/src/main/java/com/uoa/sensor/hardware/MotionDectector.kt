...
class MotionDetector @Inject constructor(
    ...
    private val LINEAR_ACCELERATION_THRESHOLD = 0.5f // Threshold for vehicle movement
    private val SIGNIFICANT_MOTION_WAIT_DURATION = 5000L // Wait duration for significant motion detection in milliseconds
    private val DEBOUNCE_INTERVAL = 10000L // Debounce interval in milliseconds to avoid frequent state changes
