...
class LocationRepositoryImplTest {
    ...
    fun testInsertLocation() = runTest {
        val location = LocationEntity(UUID.randomUUID(), 1.0, 2.0, System.currentTimeMillis(), Date(), 3.0, null, 4.0f, 5.0f, 5.0,false, false)
    ...
    fun testInsertLocationBatch() = runTest {
        val locations = listOf(
            LocationEntity(UUID.randomUUID(), 1.0, 2.0, System.currentTimeMillis(), Date(), 3.0, null, 4.0f, 5.0f,5.0,false, false),
            LocationEntity(UUID.randomUUID(), 6.0, 7.0, System.currentTimeMillis(), Date(), 8.0, null, 9.0f, 10.0f, 4.0, true, true)
        )
    ...
    fun testGetLocationById(): Unit = runTest {
        ...
        val location = LocationEntity(id, 1.0, 2.0, System.currentTimeMillis(), Date(), 3.0, null, 4.0f, 5.0f, 6.0,false, false)
    ...
    fun testGetLocationBySynced() = runTest{
        val locations = listOf(
            LocationEntity(UUID.randomUUID(), 1.0, 2.0, System.currentTimeMillis(), Date(), 3.0, null, 4.0f, 5.0f, 5.0, false, false),
            LocationEntity(UUID.randomUUID(), 6.0, 7.0, System.currentTimeMillis(), Date(), 8.0, null, 9.0f, 10.0f, 7.0, true, true)
        )
    ...
    fun testUpdateLocation() = runBlocking {
        val location = LocationEntity(UUID.randomUUID(), 1.0, 2.0, System.currentTimeMillis(), Date(), 3.0, null, 4.0f, 5.0f, 4.5, false, false)
